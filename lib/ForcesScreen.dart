...
class _ForcesScreenState extends State<ForcesScreen> {
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Forces Employees - Village Officer App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Forces_Employees_Village_Officer_App_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
      ...
      body: FutureBuilder<List<FamilyMember>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No forces employees found.'));
          }
