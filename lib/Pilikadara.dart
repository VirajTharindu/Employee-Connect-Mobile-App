...
class _PilikadaraFamiliesScreenState extends State<PilikadaraFamiliesScreen> {
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Cancer Aid Recipients - Village Officer App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Cancer_Aid_Recipients_Village_Officer_App_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: groupedPilikadaraFamilies.isEmpty
          ? const Center(
              child: Text(
                'No data available for Cancer Aid recipients.',
                style: TextStyle(
                  fontSize: 14,
                ),
              ),
