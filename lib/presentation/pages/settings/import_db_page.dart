...
class _ImportDatabaseScreenState extends State<ImportDatabaseScreen> {
  ...
  Future<void> importDatabase() async {
    ...
    try {
      ...
      String appDatabasePath = '$directory/employee_connect.db';
  ...
  Future<void> _loadDataFromActiveDatabase() async {
    try {
      final data = await DatabaseHelper.instance.retrieveAllFamilyMembers();
      setState(() {
        _dataList = data.map((member) => (member as FamilyMemberModel).toMap()).toList();
      });
