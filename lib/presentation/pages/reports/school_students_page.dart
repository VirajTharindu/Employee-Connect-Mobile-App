...
class _SchoolStudentsScreenState extends State<SchoolStudentsScreen> {
  ...
  Future<void> _fetchSchoolStudents() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryAllStudentFamilyMembers(
      minAge: minAge,
      maxAge: maxAge,
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "School Students - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "School_Students_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: groupedSchoolStudents.isEmpty
          ? const NoDataFallback(
              title: 'No Students Found',
              message: 'No school student records found to display statistics.',
            )
          : ListView.builder(
