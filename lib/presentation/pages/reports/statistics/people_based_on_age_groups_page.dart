...
class _PeopleBasedOnAgeGroupsState extends State<PeopleBasedOnAgeGroups> {
  ...
  Future<Map<String, Map<String, List<FamilyMember>>>>
    ...
    final ageGroups = await locator.familyReportService.getPeopleBasedOnAgeGroups();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "People Based on Age Groups - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "People_Based_on_Age_Groups_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'No family records found to display age group statistics.',
            );
          }
