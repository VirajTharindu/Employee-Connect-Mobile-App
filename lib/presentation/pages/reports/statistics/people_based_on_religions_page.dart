...
class _PeopleBasedOnReligionsScreenState
  ...
  Future<void> _fetchReligionFamilyMembers() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryReligionFamilyMembers();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "People Based on Religions - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "People_Based_on_Religions_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: groupedReligions.isEmpty
          ? const NoDataFallback(
              title: 'No Data Available',
              message: 'No family records found to display religion statistics.',
            )
          : ListView.builder(
