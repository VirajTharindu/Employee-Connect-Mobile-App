...
class _PeopleBasedOnEthnicityScreenState
  ...
  Future<void> _fetchEthnicityFamilyMembers() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap = await familyRepository
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "People Based on Ethnicity - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "People_Based_on_Ethnicity_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: groupedEthnicities.isEmpty
          ? const NoDataFallback(
              title: 'No Data Available',
              message: 'No family records found to display ethnicity statistics.',
            )
          : ListView.builder(
                    ...
                    children: householdMap.entries
                      ...
                      return ExpansionTile(
                        ...
                        children: members.asMap().entries.map((entry) {
                          int memberIndex =
                              entry.key + 1; // Numbering family members
