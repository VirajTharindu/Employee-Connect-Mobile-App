...
class _HigherEducationalLevelsOfAdultsScreenState
  ...
  Future<void> _fetchHigherEducationLevels() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryHigherEducationFamilyMembers();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Higher Educational Levels - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Higher_Educational_Levels_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: groupedEducationLevels.isEmpty
          ? const NoDataFallback(
              title: 'No Data Available',
              message: 'No family records found to display education statistics.',
            )
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (householdMembers == null || householdMembers.isEmpty) {
                  return ListTile(
                    ...
                    subtitle:
                        const Text("No members found for this education level"),
                  );
                }
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    ...
                    subtitle:
                        Text('Households: ${householdMembers.keys.length}'),
