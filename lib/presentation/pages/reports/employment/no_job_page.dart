...
class _NoJobScreenState extends State<NoJobScreen> {
  ...
  Future<List<FamilyMember>> _fetchNoJobFamilies() async {
    final List<FamilyMember> familyMembers =
        await locator.familyRepository.queryNoJobEmployees();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "No Job or Retired - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "No_Job_or_Retired_Employees_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'There are no family members recorded as unemployed or retired.',
            );
          }
