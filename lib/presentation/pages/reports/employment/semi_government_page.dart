...
class _SemiGovernmentScreenState extends State<SemiGovernmentScreen> {
  ...
  Future<List<FamilyMember>> _fetchSemiGovernmentFamilies() async {
    final List<FamilyMember> familyMembers =
        await locator.familyRepository.querySemiGovernmentEmployees();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Semi-Government Employees - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Semi_Government_Employees_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'There are no family members recorded under the Semi-Government job category.',
            );
          }
