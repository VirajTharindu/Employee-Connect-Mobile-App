...
class _PrivateScreenState extends State<PrivateScreen> {
  ...
  Map<String, List<FamilyMember>> groupedPrivateFamilies =
  ...
  Future<List<FamilyMember>> _fetchPrivateFamilies() async {
    final List<FamilyMember> familyMembers =
        await locator.familyRepository.queryPrivateEmployees();

    groupedPrivateFamilies = {}; // Clear map before grouping
  ...
  Future<void> generatePdf() async {
    ...
    final List<FamilyMember> members = groupedPrivateFamilies.values
    ...
    if (members.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('No Private Employees found to generate PDF'),
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Private Employees - Employee Connect App",
                    style: pw.TextStyle(
          ...
          return [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Total Households: ${groupedPrivateFamilies.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                  pw.Text(
                    "Total Private Employees: ${members.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                ],
            ...
            pw.ListView.builder(
              itemCount: groupedPrivateFamilies.length,
              itemBuilder: (context, index) {
                final householdNumber =
                    groupedPrivateFamilies.keys.toList()[index];
                final householdMembers =
                    groupedPrivateFamilies[householdNumber]!;
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Private_Employees_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    int familyCount = groupedPrivateFamilies.keys.length;
    int memberCount = groupedPrivateFamilies.values
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'There are no family members recorded under the Private sector job category.',
            );
          }
