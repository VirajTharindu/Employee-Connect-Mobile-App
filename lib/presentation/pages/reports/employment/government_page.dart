...
class _GovernmentScreenState extends State<GovernmentScreen> {
  ...
  Future<List<FamilyMember>> _fetchGovernmentFamilies() async {
    final List<FamilyMember> familyMembers =
        await locator.familyRepository.queryGovernmentEmployees();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Government Employees - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Government_Employees_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'There are no family members recorded under the Government job category.',
            );
          }
