...
class _CorporationsScreenState extends State<CorporationsScreen> {
  ...
  Future<List<FamilyMember>> _fetchCorporationFamilies() async {
    final List<FamilyMember> familyMembers =
        await locator.familyRepository.queryCorporationEmployees();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Corporation Employees - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Corporation_Employees_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const NoDataFallback(
              ...
              message: 'There are no family members recorded under the Corporations job category.',
            );
          }
