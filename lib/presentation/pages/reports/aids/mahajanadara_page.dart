...
class _MahajanadaraFamiliesScreenState
  ...
  Future<void> _fetchMahajanadaraFamilies() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryMahajanadaraFamilies();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Mahajanadara Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Mahajanadara_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
    ...
    return Scaffold(
      ...
      body: groupedMahajanadaraFamilies.isEmpty
          ? const NoDataFallback(
              ...
              message: 'There are no family members recorded as receiving Mahajanadara aid.',
            )
          : ListView.builder(
