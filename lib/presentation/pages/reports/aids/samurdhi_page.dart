...
class _SamurdhiFamiliesScreenState extends State<SamurdhiFamiliesScreen> {
  ...
  Future<void> _fetchSamurdhiFamilies() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.querySamurdhiFamilies();
  ...
  Future<void> generatePdf() async {
    ...
    final List<FamilyMember> members = groupedSamurdhiFamilies.values
    ...
    if (members.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('No Samurdhi Aid recipients found to generate PDF'),
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Samurdhi Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
          ...
          return [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Total Households: ${groupedSamurdhiFamilies.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                  pw.Text(
                    "Total Samurdhi Aid Recipients: ${members.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                ],
            ...
            pw.ListView.builder(
              itemCount: groupedSamurdhiFamilies.length,
              itemBuilder: (context, index) {
                final householdNumber =
                    groupedSamurdhiFamilies.keys.toList()[index];
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Samurdhi_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    int familyCount = groupedSamurdhiFamilies.keys.length;
    int memberCount = groupedSamurdhiFamilies.values
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            const Text('Samurdhi Aid receivers'),
            Text(
      ...
      body: groupedSamurdhiFamilies.isEmpty
          ? const NoDataFallback(
              ...
              message: 'There are no family members recorded as receiving Samurdhi aid.',
            )
          : ListView.builder(
