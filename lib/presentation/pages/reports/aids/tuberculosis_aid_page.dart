...
class _TuberculosisAidScreenState extends State<TuberculosisAidScreen> {
  ...
  Future<void> _fetchTuberculosisAidFamilies() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryTuberculosisAidFamilies();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Tuberculosis Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Tuberculosis_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
    ...
    return Scaffold(
      ...
      body: groupedTuberculosisFamilies.isEmpty
          ? const NoDataFallback(
              ...
              message: 'There are no family members recorded as receiving Tuberculosis aid.',
            )
          : ListView.builder(
