...
class _ShishshyadaraFamiliesScreenState
  ...
  Future<void> _fetchShishshyadaraFamilies() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryShishshyadaraFamilies();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Student Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Student_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
    ...
    return Scaffold(
      ...
      body: groupedShishshyadaraFamilies.isEmpty
          ? const NoDataFallback(
              ...
              message: 'There are no family members recorded as receiving Shishyadara aid.',
            )
          : ListView.builder(
              itemCount: groupedShishshyadaraFamilies.keys.length,
              itemBuilder: (context, index) {
