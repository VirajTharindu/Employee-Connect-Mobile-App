...
class _AnyAidFamiliesScreenState extends State<AnyAidFamiliesScreen> {
  ...
  Future<void> _fetchAnyAidFamilies() async {
    ...
    final List<Map<String, dynamic>> familyMembersMap =
        await familyRepository.queryAnyAidFamilies();
  ...
  Future<void> generatePdf() async {
    ...
    final List<FamilyMember> members = groupedAnyAidFamilies.values
    ...
    if (members.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('No Any Aid recipients found to generate PDF'),
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Any Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
          ...
          return [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Total Households: ${groupedAnyAidFamilies.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                  pw.Text(
                    "Total Any Aid Recipients: ${members.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                ],
            ...
            pw.ListView.builder(
              itemCount: groupedAnyAidFamilies.length,
              itemBuilder: (context, index) {
                final householdNumber =
                    groupedAnyAidFamilies.keys.toList()[index];
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Any_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    int familyCount = groupedAnyAidFamilies.keys.length;
    int memberCount = groupedAnyAidFamilies.values
    ...
    return Scaffold(
      ...
      body: groupedAnyAidFamilies.isEmpty
          ? const NoDataFallback(
              ...
              message: 'There are no family members recorded as receiving any form of aid.',
            )
          : ListView.builder(
