...
class _PilikadaraFamiliesScreenState extends State<PilikadaraFamiliesScreen> {
  ...
  Future<void> generatePdf() async {
    ...
    final List<FamilyMember> members = groupedPilikadaraFamilies.values
    ...
    if (members.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('No Cancer Aid recipients found to generate PDF'),
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Cancer Aid Recipients - Employee Connect App",
                    style: pw.TextStyle(
          ...
          return [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Total Households: ${groupedPilikadaraFamilies.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                  pw.Text(
                    "Total Cancer Aid Recipients: ${members.length}",
                    style: pw.TextStyle(
                        font: ttfBold, fontSize: 12, color: PdfColors.green900),
                  ),
                ],
            ...
            pw.ListView.builder(
              ...
              itemBuilder: (context, index) {
                final householdNumber =
                    groupedPilikadaraFamilies.keys.toList()[index];
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Cancer_Aid_Recipients_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  Widget build(BuildContext context) {
    int familyCount = groupedPilikadaraFamilies.keys.length;
    int memberCount = groupedPilikadaraFamilies.values
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            const Text('Cancer Aid receivers'),
            Text(
      ...
      body: groupedPilikadaraFamilies.isEmpty
          ? const NoDataFallback(
              title: 'No Recipients Found',
              message: 'There are no family members recorded as receiving Pilikadara aid.',
            )
          : ListView.builder(
              itemCount: groupedPilikadaraFamilies.keys.length,
              itemBuilder: (context, index) {
