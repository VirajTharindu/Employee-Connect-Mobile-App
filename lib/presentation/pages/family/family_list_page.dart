...
class _FamilyListState extends State<FamilyList> {
  ...
  void loadFamilyMembers() {
    familyMembersFuture = locator.familyRepository.retrieveAllFamilyMembers();
  ...
  Future<void> generatePdf() async {
          ...
          return pw.Container(
            ...
            child: pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "Family Registry Report - Employee Connect App",
                    style: pw.TextStyle(
    ...
    try {
      ...
      final currentDate = DateTime.now();
      final fileName =
          "Family_Registry_Report_Employee_Connect_${currentDate.day}-${currentDate.month}-${currentDate.year}.pdf";
  ...
  void deleteHousehold(String householdNumber) async {
    ...
    if (confirmed == true) {
      await locator.familyRepository.deleteFamilyByHousehold(householdNumber);
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return NoDataFallback(
              ...
              message: 'Get started by adding your first family record to the database.',
              actionLabel: 'Add Family Member',
              onAction: () => Navigator.pushNamed(context, '/family_member_form'),
            );
          } else {
            Map<String, List<FamilyMember>> groupedByHousehold = {};
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      radius: 20, // Increased radius slightly
